#!/bin/bash
# ============================================================================
# Run Step 2: Train EMT_E2M2E Setting 6 (Interpolated Data)
# ============================================================================
# This script trains models for Setting 6 which uses:
# - Boundary time points (0d, 3d_rm): Real data
# - Intermediate time points: Linearly interpolated data
#
...
# ============================================================================
# Hardcoded Parameters - Specific for EMT_E2M2E Setting 6
# ============================================================================

# Configuration file
CONFIG_FILE="experiment_EMT_E2M2E_setting6_interpolated.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/EMT_E2M2E"

# Output directory
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M2E/Setting6"
...
echo "========================================"
echo "Step 2: Train EMT_E2M2E Setting 6"
echo "        (Interpolated Data)"
echo "========================================"
echo ""
echo "Experiment Description:"
echo "  - Boundary points (0d, 3d_rm): Real data"
echo "  - Intermediate points: Linearly interpolated"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (EMT_E2M2E Setting 6)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (EMT_E2M2E Setting 6)"
    echo "========================================"
    echo ""
