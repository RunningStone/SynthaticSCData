#!/bin/bash
# ============================================================================
# Step 4: Analyze Ablation Study Results for EMT_E2M2E
# ============================================================================
#
...
#
# Ablation experiments for EMT_E2M2E:
#   - Setting4_Ablation_Remove8h: Remove 8h timepoint
#   - Setting4_Ablation_Remove1d: Remove 1d timepoint
#   - Setting4_Ablation_Remove3d: Remove 3d timepoint
#   - Setting4_Ablation_Remove7d: Remove 7d timepoint (peak EMT)
#   - Setting4_Ablation_Remove8h_rm: Remove 8h_rm timepoint
#   - Setting4_Ablation_Remove1d_rm: Remove 1d_rm timepoint
#
# Usage:
...
echo "========================================================================"
echo "Step 4: Ablation Study Analysis (EMT_E2M2E)"
echo "========================================================================"
echo ""
...
ABLATION_DIRS=(
    "Setting4_Ablation_Remove8h"
    "Setting4_Ablation_Remove1d"
    "Setting4_Ablation_Remove3d"
    "Setting4_Ablation_Remove7d"
    "Setting4_Ablation_Remove8h_rm"
    "Setting4_Ablation_Remove1d_rm"
)
...
ablations = {
    "Remove_8h": f"{base_output}/Setting4_Ablation_Remove8h/evaluation_results.json",
    "Remove_1d": f"{base_output}/Setting4_Ablation_Remove1d/evaluation_results.json",
    "Remove_3d": f"{base_output}/Setting4_Ablation_Remove3d/evaluation_results.json",
    "Remove_7d": f"{base_output}/Setting4_Ablation_Remove7d/evaluation_results.json",
    "Remove_8h_rm": f"{base_output}/Setting4_Ablation_Remove8h_rm/evaluation_results.json",
    "Remove_1d_rm": f"{base_output}/Setting4_Ablation_Remove1d_rm/evaluation_results.json",
}
...
report = []
report.append("=" * 80)
report.append("EMT_E2M2E Ablation Study Analysis")
report.append("=" * 80)
report.append("")
report.append("Baseline: Setting2 (Full trajectory: 0d → 8h → 1d → 3d → 7d → 8h_rm → 1d_rm → 3d_rm)")
report.append("")
...
report.append("")
report.append("Forward EMT timepoints: 8h, 1d, 3d, 7d")
report.append("Reversal timepoints: 8h_rm, 1d_rm")
report.append("")
