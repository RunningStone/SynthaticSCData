#!/bin/bash
# Run Step 2: Train EMT_E2M2E Setting 3
# This script trains models for Setting 3 (key time points)
# Time points: 0d, 7d, 3d_rm (start, peak EMT, reversal endpoint)
# Specific for EMT_E2M2E experiment configurations
# 
...
# Hardcoded parameters - specific for EMT_E2M2E Setting 3
CONFIG_FILE="experiment_EMT_E2M2E_setting3.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/EMT_E2M2E"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M2E/Setting3"

# Print configuration
echo "========================================"
echo "Step 2: Train EMT_E2M2E Setting 3"
echo "========================================"
echo ""
...
echo "  Time points: 0d, 7d, 3d_rm (key timepoints: start, peak, reversal endpoint)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (EMT_E2M2E Setting 3)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (EMT_E2M2E Setting 3)"
    echo "========================================"
    echo ""
