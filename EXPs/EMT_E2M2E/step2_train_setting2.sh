#!/bin/bash
# Run Step 2: Train EMT_E2M2E Setting 2
# This script trains models for Setting 2 (full trajectory with reversal)
# Time points: 0d, 8h, 1d, 3d, 7d, 8h_rm, 1d_rm, 3d_rm
...
# Hardcoded parameters - specific for EMT_E2M2E Setting 2
CONFIG_FILE="experiment_EMT_E2M2E_setting2.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/EMT_E2M2E"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M2E/Setting2"

# Print configuration
echo "========================================"
echo "Step 2: Train EMT_E2M2E Setting 2"
echo "========================================"
echo ""
...
echo "  Time points: 0d, 8h, 1d, 3d, 7d, 8h_rm, 1d_rm, 3d_rm (full trajectory)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (EMT_E2M2E Setting 2)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (EMT_E2M2E Setting 2)"
    echo "========================================"
    echo ""
