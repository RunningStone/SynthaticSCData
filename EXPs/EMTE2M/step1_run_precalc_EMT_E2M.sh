#!/bin/bash
# Run Step 1: Pre-calculation Experiments for EMT_E2M
...
# Hardcoded parameters - specific for EMT_E2M experiment
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M/precalc_results"
DATA_CONFIG="$PROJECT_ROOT/configs/EMT_E2M/data_EMT_Cook_with_label.yaml"
BATCH_SIZE=256
...
echo ""
echo "========================================"
echo "✓ Pre-calculation Complete (EMT_E2M)"
echo "========================================"
echo ""
...
echo ""
echo "2. Update your experiment configurations in configs/EMT_E2M/"
echo ""
echo "3. Run EMT_E2M training experiments from EXPs/EMTE2M/"
echo ""
