#!/bin/bash
# ============================================================================
# Run Step 2: Train EMT_E2M Setting 6 (Interpolated Data)
# ============================================================================
# This script trains models for Setting 6 which uses:
# - Boundary time points (0d, 7d): Real data
# - Intermediate time points (8h, 1d, 3d): Linearly interpolated data
#
...
# ============================================================================
# Hardcoded Parameters - Specific for EMT_E2M Setting 6
# ============================================================================
...
# Output directory
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M/Setting6"
...
echo "========================================"
echo "Step 2: Train EMT_E2M Setting 6"
echo "        (Interpolated Data)"
echo "========================================"
echo ""
echo "Experiment Description:"
echo "  - Boundary points (0d, 7d): Real data"
echo "  - Intermediate points (8h, 1d, 3d): Linearly interpolated"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (EMT_E2M Setting 6)"
    echo "========================================"
    echo ""
    ...
    echo "  4. Run visualization: bash step3_visualize_setting6.sh"
    echo ""
else
    echo "❌ Training Failed (EMT_E2M Setting 6)"
    echo "========================================"
    echo ""
