#!/bin/bash
# ============================================================================
# Step 3: Run Inference on Test Set for All Settings
# ============================================================================
#
...
#                     e.g., /home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M
#
# The script will:
...
#   3. Handle nested folders (e.g., Setting4/Setting4_Ablation_Remove1d)
#
...
# Parse arguments
if [ $# -lt 1 ]; then
    echo "Usage: bash step3_run_inference.sh <base_output_dir>"
    echo ""
    echo "Example:"
    echo "  bash step3_run_inference.sh /home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M"
    exit 1
fi
...
echo "========================================================================"
echo "Step 3: Run Inference on Test Set"
echo "========================================================================"
echo ""
...
# Counters (initialize to 1 to avoid ((x++)) returning 1 when x=0)
TOTAL=0
SUCCESS=0
FAILED=0
SKIPPED=0
