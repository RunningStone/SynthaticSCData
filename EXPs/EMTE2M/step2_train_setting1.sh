#!/bin/bash
# Run Step 2: Train EMT_E2M Setting 1
# This script trains models for Setting 1 (boundary time points only: 0d and 7d)
...
# Hardcoded parameters - specific for EMT_E2M Setting 1
CONFIG_FILE="experiment_EMT_Part1_setting1.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/EMT_E2M"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/EMT_E2M/Setting1"

# Print configuration
echo "========================================"
echo "Step 2: Train EMT_E2M Setting 1"
echo "========================================"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (EMT_E2M Setting 1)"
    echo "========================================"
    echo ""
    ...
    echo "3. Run evaluation: bash step3_evaluate_setting1.sh"
    echo ""
else
    echo "❌ Training Failed (EMT_E2M Setting 1)"
    echo "========================================"
    echo ""
