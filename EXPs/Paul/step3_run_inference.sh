#!/bin/bash
# ============================================================================
# Step 3: Run Inference on Test Set for All Settings (Paul EMT)
# ============================================================================
#
...
#                     Default: /home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul
#
# The script will:
...
# Parse arguments - use default if not provided
BASE_OUTPUT="${1:-/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul}"

echo "========================================================================"
echo "Step 3: Run Inference on Test Set (Paul EMT)"
echo "========================================================================"
echo ""
...
echo ""
echo "========================================================================"
echo "Inference Summary (Paul EMT)"
echo "========================================================================"
echo ""
