#!/bin/bash
# Run Step 2: Train Paul EMT Setting 3
# This script trains models for Setting 3 (key timepoints: T0, T4, T7)
...
# Hardcoded parameters - specific for Paul EMT Setting 3
CONFIG_FILE="experiment_Paul_setting3.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/Paul"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul/Setting3"

# Print configuration
echo "========================================"
echo "Step 2: Train Paul EMT Setting 3"
echo "========================================"
echo ""
...
echo "  Time points: T0, T4, T7 (start-middle-end trajectory)"
echo "  Models: MLPlus SB, Batch OT, Conditional VAE"
echo "  Total cells: 450 (150 per timepoint)"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (Paul EMT Setting 3)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (Paul EMT Setting 3)"
    echo "========================================"
    echo ""
