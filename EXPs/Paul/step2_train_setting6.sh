#!/bin/bash
# ============================================================================
# Run Step 2: Train Paul EMT Setting 6 (Interpolated Data)
# ============================================================================
# This script trains models for Setting 6 which uses:
# - Boundary time points (T0, T7): Real data
# - Intermediate time points (T1-T6): Linearly interpolated data
#
...
# ============================================================================
# Hardcoded Parameters - Specific for Paul EMT Setting 6
# ============================================================================

# Configuration file
CONFIG_FILE="experiment_Paul_setting6_interpolated.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/Paul"

# Output directory
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul/Setting6"
...
echo "========================================"
echo "Step 2: Train Paul EMT Setting 6"
echo "        (Interpolated Data)"
echo "========================================"
echo ""
echo "Experiment Description:"
echo "  - Boundary points (T0, T7): Real data"
echo "  - Intermediate points (T1-T6): Linearly interpolated"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (Paul EMT Setting 6)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (Paul EMT Setting 6)"
    echo "========================================"
    echo ""
