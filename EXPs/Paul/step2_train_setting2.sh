#!/bin/bash
# Run Step 2: Train Paul EMT Setting 2
# This script trains models for Setting 2 (all 8 time points: T0→T1→T2→T3→T4→T5→T6→T7)
...
# Hardcoded parameters - specific for Paul EMT Setting 2
CONFIG_FILE="experiment_Paul_setting2.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/Paul"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul/Setting2"

# Print configuration
echo "========================================"
echo "Step 2: Train Paul EMT Setting 2"
echo "========================================"
echo ""
...
echo "  Time points: T0, T1, T2, T3, T4, T5, T6, T7 (all 8 timepoints)"
echo "  Models: MLPlus SB, Batch OT, Conditional VAE"
echo "  Total cells: 1,200 (150 per timepoint)"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (Paul EMT Setting 2)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (Paul EMT Setting 2)"
    echo "========================================"
    echo ""
