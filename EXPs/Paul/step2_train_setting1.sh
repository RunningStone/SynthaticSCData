#!/bin/bash
# Run Step 2: Train Paul EMT Setting 1
# This script trains models for Setting 1 (boundary time points only: T0 and T7)
...
# Hardcoded parameters - specific for Paul EMT Setting 1
CONFIG_FILE="experiment_Paul_setting1.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/Paul"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/Paul/Setting1"

# Print configuration
echo "========================================"
echo "Step 2: Train Paul EMT Setting 1"
echo "========================================"
echo ""
...
echo "  Time points: T0, T7 (boundary only)"
echo "  Models: SB, OT, VAE"
echo "  Cells per timepoint: 150"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (Paul EMT Setting 1)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (Paul EMT Setting 1)"
    echo "========================================"
    echo ""
