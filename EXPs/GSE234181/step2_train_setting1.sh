#!/bin/bash
# Run Step 2: Train GSE234181 Setting 1
# This script trains models for Setting 1 (boundary time points only: T0 and T3)
...
# Hardcoded parameters - specific for GSE234181 Setting 1
CONFIG_FILE="experiment_GSE234181_setting1.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE234181"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181/Setting1"

# Print configuration
echo "========================================"
echo "Step 2: Train GSE234181 Setting 1"
echo "========================================"
echo ""
...
echo "  Time points: T0, T3 (boundary only)"
echo "  Models: MLPlus SB, Batch OT, Conditional VAE"
echo "  Cells per timepoint: 2,000"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE234181 Setting 1)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (GSE234181 Setting 1)"
    echo "========================================"
    echo ""
