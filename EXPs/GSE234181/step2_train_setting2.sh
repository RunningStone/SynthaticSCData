#!/bin/bash
# Run Step 2: Train GSE234181 Setting 2
# This script trains models for Setting 2 (all time points: T0, T1, T2, T3)
...
# Hardcoded parameters - specific for GSE234181 Setting 2
CONFIG_FILE="experiment_GSE234181_setting2.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE234181"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181/Setting2"

# Print configuration
echo "========================================"
echo "Step 2: Train GSE234181 Setting 2"
echo "========================================"
echo ""
...
echo "  Time points: T0, T1, T2, T3 (all 4 timepoints)"
echo "  Models: MLPlus SB, Batch OT, Conditional VAE"
echo "  Total cells: 4,000 (across all timepoints)"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE234181 Setting 2)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (GSE234181 Setting 2)"
    echo "========================================"
    echo ""
