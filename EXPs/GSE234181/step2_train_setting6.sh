#!/bin/bash
# ============================================================================
# Run Step 2: Train GSE234181 Setting 6 (Interpolated Data)
# ============================================================================
# This script trains models for Setting 6 which uses:
# - Boundary time points (T0, T3): Real data
# - Intermediate time points (T1, T2): Linearly interpolated data
#
...
# ============================================================================
# Hardcoded Parameters - Specific for GSE234181 Setting 6
# ============================================================================

# Configuration file
CONFIG_FILE="experiment_GSE234181_setting6_interpolated.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE234181"

# Output directory
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181/Setting6"
...
echo "========================================"
echo "Step 2: Train GSE234181 Setting 6"
echo "        (Interpolated Data)"
echo "========================================"
echo ""
echo "Experiment Description:"
echo "  - Boundary points (T0, T3): Real data"
echo "  - Intermediate points (T1, T2): Linearly interpolated"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE234181 Setting 6)"
    echo "========================================"
    echo ""
    ...
    echo "  4. Run visualization: bash step4_analyse_vis.sh"
    echo ""
else
    echo "❌ Training Failed (GSE234181 Setting 6)"
    echo "========================================"
    echo ""
