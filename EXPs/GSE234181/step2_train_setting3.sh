#!/bin/bash
# Run Step 2: Train GSE234181 Setting 3
# This script trains models for Setting 3 (key time points: T0, T1, T3)
...
# Hardcoded parameters - specific for GSE234181 Setting 3
CONFIG_FILE="experiment_GSE234181_setting3.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE234181"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181/Setting3"

# Print configuration
echo "========================================"
echo "Step 2: Train GSE234181 Setting 3"
echo "========================================"
echo ""
...
echo "  Time points: T0, T1, T3 (key timepoints)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE234181 Setting 3)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (GSE234181 Setting 3)"
    echo "========================================"
    echo ""
