#!/bin/bash
################################################################################
# Run Setting 5 Experiment: Label-Shuffled Time Series (GSE234181)
################################################################################
...
#
# Design:
#   - Keep boundary timepoints (T0, T3) with original labels
#   - Shuffle labels among intermediate timepoints (T1, T2)
...
echo "================================================================================"
echo "Setting 5 Experiment: Label-Shuffled Time Series (GSE234181)"
echo "================================================================================"
...
echo ""
echo "Design:"
echo "  1. Keep boundary timepoints (T0, T3) with original labels"
echo "  2. Shuffle labels among intermediate timepoints (T1, T2)"
echo "  3. Train models: sb_mlplus, batch_ot, vae"
echo "  4. Evaluate on true labels (T0 → T3)"
echo ""
echo "================================================================================"
echo ""

# Configuration
CONFIG_FILE="experiment_GSE234181_setting5_label_shuffled.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE234181"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181/Setting5"
