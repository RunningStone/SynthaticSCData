#!/bin/bash
# ============================================================================
# Step 3: Run Inference on Test Set for All Settings (GSE234181)
# ============================================================================
#
...
#                     Default: /home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181
#
# The script will:
...
#   3. Handle nested folders (e.g., Setting4/Setting4_Ablation_RemoveT1)
#
...
# Default base output directory for GSE234181
DEFAULT_BASE_OUTPUT="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE234181"

# Parse arguments
BASE_OUTPUT="${1:-$DEFAULT_BASE_OUTPUT}"

echo "========================================================================"
echo "Step 3: Run Inference on Test Set (GSE234181)"
echo "========================================================================"
echo ""
...
echo ""
echo "========================================================================"
echo "Inference Summary (GSE234181)"
echo "========================================================================"
echo ""
