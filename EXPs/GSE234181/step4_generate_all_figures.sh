#!/bin/bash
################################################################################
# Step 4: Generate All Publication Figures - GSE234181 Dataset
################################################################################
...
#
# Dataset: GSE234181 (Dormancy and Awakening Trajectory)
...
echo "================================================================================"
echo "Step 4: Generate All Publication Figures - GSE234181"
echo "================================================================================"
...
echo "Configuration:"
echo "  Dataset: GSE234181 (Dormancy and Awakening)"
echo "  Timepoints: T0 → T1 → T2 → T3"
...
echo "================================================================================"
echo ""
echo "Dataset: GSE234181 (Dormancy and Awakening Trajectory)"
echo "Timepoints: T0 → T1 → T2 → T3"
echo ""
