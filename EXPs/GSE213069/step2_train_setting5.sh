#!/bin/bash
################################################################################
# Run Setting 5 Experiment: Label-Shuffled Time Series (GSE213069)
################################################################################
...
#
# Design:
#   - Keep boundary timepoints (T0, day5) with original labels
#   - Shuffle labels among intermediate timepoints (day2, day3, day4)
...
echo "================================================================================"
echo "Setting 5 Experiment: Label-Shuffled Time Series (GSE213069)"
echo "================================================================================"
...
echo ""
echo "Design:"
echo "  1. Keep boundary timepoints (T0, day5) with original labels"
echo "  2. Shuffle labels among intermediate timepoints (day2, day3, day4)"
echo "  3. Train models: sb_mlplus, batch_ot, vae"
echo "  4. Evaluate on true labels (T0 → day5)"
echo ""
echo "================================================================================"
echo ""

# Configuration
CONFIG_FILE="experiment_GSE213069_setting5_label_shuffled.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE123069"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1/Setting5_LabelShuffled"
