#!/bin/bash
# ============================================================================
# Step 3: Run Inference on Test Set for All Settings (GSE213069)
# ============================================================================
#
...
#                     Default: /home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1
#
# The script will:
...
#   3. Handle nested folders (e.g., Setting4_Ablation_RemoveDay2)
#
...
# Default base output directory for GSE213069
DEFAULT_BASE_OUTPUT="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1"

# Parse arguments
BASE_OUTPUT="${1:-$DEFAULT_BASE_OUTPUT}"

echo "========================================================================"
echo "Step 3: Run Inference on Test Set (GSE213069)"
echo "========================================================================"
echo ""
...
echo ""
echo "========================================================================"
echo "Inference Summary (GSE213069)"
echo "========================================================================"
echo ""
