#!/bin/bash
# Run Step 2: Train GSE213069 Setting 2
# This script trains models for Setting 2 (all time points: T0, day2, day3, day4, day5)
...
# Hardcoded parameters - specific for GSE213069 Setting 2
CONFIG_FILE="experiment_GSE213069_setting2.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE123069"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1/Setting2_FullTrajectory"

# Print configuration
echo "========================================"
echo "Step 2: Train GSE213069 Setting 2"
echo "========================================"
echo ""
...
echo "  Time points: T0, day2, day3, day4, day5 (all 5 timepoints)"
echo "  Models: SB_MLPlus, Batch OT, Conditional VAE"
echo "  Total cells: 2,500 (across all timepoints)"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE213069 Setting 2)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (GSE213069 Setting 2)"
    echo "========================================"
    echo ""
