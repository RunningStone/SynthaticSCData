#!/bin/bash
################################################################################
# Step 4: Generate All Publication Figures - GSE213069 Dataset
################################################################################
...
#
# Dataset: GSE213069 (Perturbation Time Course)
# Timepoints: T0 → day2 → day3 → day4 → day5
#
# Usage:
...
echo "================================================================================"
echo "Step 4: Generate All Publication Figures - GSE213069"
echo "================================================================================"
...
echo "Configuration:"
echo "  Dataset: GSE213069 (Perturbation Time Course)"
echo "  Timepoints: T0 → day2 → day3 → day4 → day5"
...
# Check if Setting4 ablation directories exist before running
if [ -d "$OUTPUT_BASE/Setting4/Setting4_Ablation_RemoveDay2" ] || [ -d "$OUTPUT_BASE/Setting4/Setting4_Ablation_RemoveDay3" ] || [ -d "$OUTPUT_BASE/Setting4/Setting4_Ablation_RemoveDay4" ]; then
    ...
    echo "⚠️ Setting4 ablation directories not found, skipping Figure 2 (Ablation Analysis)"
fi
