#!/bin/bash
# Run Step 2: Train GSE213069 Setting 1
# This script trains models for Setting 1 (boundary time points only: T0 and day5)
...
# Hardcoded parameters - specific for GSE213069 Setting 1
CONFIG_FILE="experiment_GSE213069_setting1.yaml"
CONFIG_DIR="$PROJECT_ROOT/configs/GSE123069"
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1/Setting1_Boundary"

# Print configuration
echo "========================================"
echo "Step 2: Train GSE213069 Setting 1"
echo "========================================"
echo ""
...
echo "  Time points: T0, day5 (boundary only)"
echo "  Models: SB, OT, Conditional VAE"
echo "  Cells per timepoint: 500"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Training Complete (GSE213069 Setting 1)"
    echo "========================================"
    echo ""
    ...
    echo "❌ Training Failed (GSE213069 Setting 1)"
    echo "========================================"
    echo ""
