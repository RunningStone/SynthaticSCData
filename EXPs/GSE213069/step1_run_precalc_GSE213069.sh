#!/bin/bash
# Run Step 1: Pre-calculation Experiments for GSE213069
...
# Hardcoded parameters - specific for GSE213069 experiment
OUTPUT_DIR="/home/pan/Experiments/EXPs/2025_10_VCC_Exps/OUTPUTs/GSE213069_V1/precalc_results"
DATA_CONFIG="$PROJECT_ROOT/configs/GSE123069/data_GSE213069_V1.yaml"
BATCH_SIZE=256
...
echo ""
echo "========================================"
echo "✓ Pre-calculation Complete (GSE213069)"
echo "========================================"
echo ""
...
echo ""
echo "2. Update your experiment configurations in configs/GSE123069/"
echo ""
echo "3. Run GSE213069 training experiments from EXPs/GSE213069/"
echo ""
